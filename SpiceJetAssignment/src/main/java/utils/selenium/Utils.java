...
public class Utils implements ITestListener{
	...
	public void reportStarter() {
		try {
			...
			extent = new ExtentReports("SpiceJetProjectReport.html", true);
	...
	public static boolean waitforele(WebElement element, String id) {
		boolean flag = false;
	...
	public static void reportFinisher() {
	...
	public String screenShot(WebDriver screen, String imgpath) throws Exception
	{
		String image = "";
		...
		try
		{
			...
			File imgfile = new File(capture(screen, dest));
